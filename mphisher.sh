...
banner() {
	cat <<- EOF
		...
		${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created By MANOJ${WHITE}
	EOF
}
...
about() {
	...
	cat <<- EOF
		...
		${GREEN}Github   ${RED}:  ${CYAN}https://github.com/DarkMemberGH
		${GREEN}Join us  ${RED}:  ${CYAN}https://darkmember.home.blog
